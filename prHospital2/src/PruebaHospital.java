...
public class PruebaHospital {
	public static void main(String [] args) {
		...
		Hospital hospital = new Hospital("La Gloria", "Camino del Cielo s/n", new Departamento[] {dep1, dep2, dep3});
		...
		me.setCategoriaProfesional(Categoria.INTERINO);
		System.out.println(me.getCategoriaProfesional());
		
		System.out.println(me.getHorasSemanales());
		System.out.println("-------------------------testes paciente---------------------------------");
		System.out.println(pac1.getAltura());
		System.out.println(pac1.getDni());
		System.out.println(pac1.getIndiceMasaCorporal());
		System.out.println(pac1.getNumSegsocial());
		System.out.println(pac1.toString());
		
		System.out.println("-------------------testes departamento---------------------");
		System.out.println(dep1.getNumMedicos());
		System.out.println(dep1.getMedico("982840"));
		System.out.println(dep1.getMedico(med1.getDni()));
		System.out.println(dep1.trabajaEnDepartamento(med1));
		System.out.println(dep1.trabajaEnDepartamento(med4));
