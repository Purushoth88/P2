...
public class SieteyMedia {
	public static void main(String[] args) {
		...
		//La banca se planta si el jugador se ha pasado; en caso contrario pide cartas
		...
		if(puntosJ<=7.5 && (puntosB>7.5 || puntosJ>puntosB)){
			...
			System.out.println("No hay ganador: Jugador "+ jugador+" ("+puntosJ+" puntos) y banca "+ banca +" ("+puntosB+" puntos) se han pasado");
		}
	}
}
